...
const getBlogPost = (slug: string) => {
  const posts: Record<string, { title: string; date: string; author: string; content: string }> = {
    ...
    "speed-is-the-only-moat": {
      ...
      author: "Ahmad Mohamed Yoosuf",
      content: `
      <p>We built many things in a few weeks. Not just because we're exceptional, but because we had to. In the time it would take to write a requirements document, the entire competitive landscape can shift. Speed isn't just an advantage. It's the only sustainable one.</p>
    ...
    <div className="min-h-screen bg-obsidian-950 text-platinum-100">
      <div className="container px-4 py-24 mx-auto max-w-4xl">
        ...
        <article className="prose prose-invert prose-lg max-w-none">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-luxury leading-tight">{post.title}</h1>
