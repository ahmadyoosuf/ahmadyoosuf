  ...
  const posts = {
    ...
    "building-ai-products": {
      ...
      content: `
        ...
        <p>For developer tools like A11y, the API design, documentation, and integration process are as important as the core functionality.</p>
    ...
    "speed-is-the-only-moat": {
      ...
      content: `
        ...
        <p>The goal isn't to be fastest at everything. It's to be fastest at what matters. And what matters changes. Speed includes the ability to change direction quickly when you learn what actually matters.</p>
        
        <h2>Why This Matters Now</h2>
        <p>AI isn't just changing how we build. It's changing how fast others can copy what we build. In this new world, sustainable advantage doesn't come from what you've built. It comes from how fast you can build the next thing.</p>
        
        <p>The companies that will thrive aren't the ones with the best features. They're the ones with the fastest learning loops. The ones that can go from idea to user feedback while their competitors are still in planning meetings.</p>
